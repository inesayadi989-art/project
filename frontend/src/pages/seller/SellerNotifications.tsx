        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Gardez un œil sur les demandes d’abonnement et les confirmations de paiement.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          {isLoading ? (
            ...
            <div className="text-center py-16 text-gray-500">
              ...
              <p className="mt-2">Les nouvelles notifications apparaîtront ici lorsque l’administrateur validera votre abonnement ou que votre paiement sera confirmé.</p>
            </div>
          ) : (
