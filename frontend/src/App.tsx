...
const D17PaymentPage = lazy(() => import('./pages/D17PaymentPage'))
...
export default function App() {
  const { user, profile, loading } = useAuthStore()
  console.log('App render:', { user: !!user, profile, loading })
    ...
    <>
      ...
      <Suspense fallback={<LoadingSpinner fullscreen />}>
        <Routes>
          ...
          <Route
            path="/admin/users"
            element={<RoleRoute role="admin"><AdminUsers /></RoleRoute>}
          />
          <Route
            path="/admin/products"
            element={<RoleRoute role="admin"><AdminProducts /></RoleRoute>}
          />
          <Route
            path="/admin/orders"
            element={<RoleRoute role="admin"><AdminOrders /></RoleRoute>}
          />
